...
<script id="productTemplate" type="text/x-handlebars-template">
    <div class="col product-{{ id }}" data-cols="1/4" data-medium-cols="1/2" data-small-cols="1">
        <div onclick="window.location = '{{ url }}'" class="categoryItem animated flipInY" >
    ...
    $.post('<?php echo site_url('category/products/count');?>', {categoryId:params.categoryId}, function(data) {
        ...
        if(totalProducts > 0)
        {
            ...
            do {
                ...
                $('#products').append('<div class="col-nest productPage" id="page-'+pagination+'" data-page="'+pagination+'"></div>');
                i += params.rows;
                pagination++;
